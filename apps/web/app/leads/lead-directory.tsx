...
export function LeadDirectoryTable({ items, ariaLabel }: Readonly<{ items: ApiObject[]; ariaLabel: string }>): React.JSX.Element {
  return <section className="lead-directory" aria-label={`${items.length} prospects affichés`}>
    ...
    <div className="lead-directory__table-wrap">
      <table aria-label={ariaLabel}>
        ...
        <thead><tr><th scope="col">Prospect</th><th scope="col">Situation</th><th scope="col">Formation</th><th scope="col">Affectation</th><th scope="col"><span className="sr-only">Action</span></th></tr></thead>
        <tbody>{items.map((item, index) => {
          ...
          return <tr key={id || code}>
            ...
            <td className="lead-directory__situation" data-label="Situation">
...
export function LeadDirectory({ endpoint, ariaLabel, emptyMessage }: Readonly<{ endpoint: string; ariaLabel: string; emptyMessage: string }>): React.JSX.Element {
  ...
  return <LeadDirectoryTable items={state.items} ariaLabel={ariaLabel} />;
}
