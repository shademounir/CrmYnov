...
internal sealed class LinphoneEngine : IDisposable
{
    ...
    public void StartCall(AgentCommand command)
    {
        ...
        activeCommandId = command.CommandId; activeCallId = command.CallId; lastState = null;
    ...
    private void OnCallState(Call call, CallState state)
    {
        ...
        if (mapped.Item1 is "ENDED" or "FAILED" or "MISSED" or "CANCELLED") { activeCall = null; activeCommandId = null; activeCallId = null; }
    }
