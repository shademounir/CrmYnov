...
export class CandidateDocumentController {
  ...
  private principal(request: DocumentRequest): Principal { if (!request.principal) throw new BadRequestException({ code: "principal_missing" }); return request.principal; }
