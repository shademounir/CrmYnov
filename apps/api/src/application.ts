...
export function configureApplication(app: INestApplication): void {
  ...
  const openApi = {
    ...
    paths: {
      ...
      "/users/{id}/temporary-secret": { post: { summary: "Issue a one-time displayed temporary secret and revoke existing sessions", responses: { "201": { description: "Temporary secret returned once; first-login replacement required" }, "403": { description: "SUPER_ADMIN, confirmation, active collaborator or credential store required" } } } },
