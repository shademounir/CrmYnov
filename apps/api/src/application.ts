  ...
  const openApi = {
    ...
    paths: {
      ...
      "/leads": {
        ...
        get: { summary: "List globally visible leads with deterministic pagination", responses: { "200": { description: "Paginated leads with role-based masking" }, "400": { description: "Invalid pagination" }, "403": { description: "Role refused" } } },
      },
