# CRMY-171 — Connecteurs, exécutions et soumissions

Les index uniques portent sur deux tables créées vides dans cette migration (classeur/onglet et connecteur/identifiant externe). Le cycle HTTP/PostgreSQL prouve premier import et rejeu sans doublon.
