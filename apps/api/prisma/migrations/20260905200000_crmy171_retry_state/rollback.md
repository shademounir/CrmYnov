# CRMY-171 — Reprise bornée

Le compteur ajouté vaut zéro ; la contrainte non négative est conservée. Aucun rejeu ou lancement n'est déclenché par la migration.
