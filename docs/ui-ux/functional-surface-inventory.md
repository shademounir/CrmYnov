...
Date de l’inventaire local : 10 septembre 2026.
...
| CRMY-165 | Travail quotidien | `/manager/reports/commercial-funnel`, `/appointments`, `/notifications`, `/calls/queue` | funnel, relances, rendez-vous, notifications, téléphonie | funnel alimenté par le snapshot persistant ; autres sous-domaines partiellement mémoire | pilote Pipeline et tests de contrat | revue visuelle finale et preuves de mutations réelles par sous-domaine |
